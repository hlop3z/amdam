...
const abzSnippetBar = {
    ...
    props: {},
    data: () => ({
        allowed_langs: [ "python", "javascript", "html", "sh", "css", "json", "mysql", "pgsql", "sql", "batchfile", "powershell", "ini", "makefile", "text", "nginx", "apache_conf", "dockerfile", "handlebars", "markdown" ]
    }),
    created() {},
    mounted() {
        var element = this.$el;
