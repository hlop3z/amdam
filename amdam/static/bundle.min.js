...
$ablaze.cookie.set = function(e, t, a) {
    var i = new Date;
    i.setTime(i.getTime() + 24 * a * 60 * 60 * 1e3);
    var s = "expires=" + i.toUTCString();
    document.cookie = e + "=" + t + ";" + s + ";path=/"
};
$ablaze.cookie.get = function(e) {
...
$ablaze.cookie.delete = function(e) {
    document.cookie = e + "=;expires=Thu, 01 Jan 1970 00:00:01 GMT;"
};
$ablaze.storage.local.set = function(e, t) {
    localStorage.setItem(e, JSON.stringify(t))
};
$ablaze.storage.local.get = function(e) {
    return JSON.parse(localStorage.getItem(e))
};
$ablaze.storage.local.remove = function(e) {
    localStorage.removeItem(e)
};
$ablaze.storage.local.clear = function() {
    localStorage.clear()
};
$ablaze.storage.session.set = function(e, t) {
    sessionStorage.setItem(e, JSON.stringify(t))
};
$ablaze.storage.session.remove = function(e) {
...
$ablaze.loop = (e, t, ...a) => {
    for (var i = 0; i < e; i++) t(...a)
};
$ablaze.debounce = function(e, t, a) {
    var i;
    return function() {
        var s = this,
            o = arguments,
...
$ablaze.throttle = function(e, t, a) {
    var i, s, o, l = null,
        n = 0;
    a || (a = {});
    var r = function() {
        n = !1 === a.leading ? 0 : Date.now();
        l = null;
        o = e.apply(i, s);
        l || (i = s = null)
    };
    return function() {
        ...
        if (p <= 0 || p > t) {
            ...
            o = e.apply(i, s);
            l || (i = s = null)
        } else l || !1 === a.trailing || (l = setTimeout(r, p));
        return o
    }
};
$ablaze.reverse = e => e.split("").reverse().join("");
$ablaze.is.function = function(e) {
    return "function" == typeof e
};
$ablaze.is.obj = function(e) {
    return e && "object" == typeof e && e.constructor === Object
};
$ablaze.is.str = function(e) {
    return "string" == typeof e || e instanceof String
};
$ablaze.is.num = function(e) {
    return "number" == typeof e && isFinite(e)
};
$ablaze.is.list = function(e) {
    return e && "object" == typeof e && e.constructor === Array
};
$ablaze.is.null = function(e) {
    return null === e
};
$ablaze.is.undefined = function(e) {
    return void 0 === e
};
$ablaze.is.boolean = function(e) {
    return "boolean" == typeof e
};
$ablaze.is.date = function(e) {
    return e instanceof Date
};
$ablaze.is.regex = function(e) {
    return e && "object" == typeof e && e.constructor === RegExp
};
$ablaze.is.error = function(e) {
    return e instanceof Error && void 0 !== e.message
};
$ablaze.is.symbol = function(e) {
    return "symbol" == typeof e
};
$ablaze.json.download = function(e, t) {
    var a = "data:text/json;charset=utf-8," + encodeURIComponent(JSON.stringify(e)),
...
$ablaze.filter.capitalize = function(e) {
    return e ? (e = (e = e.toString()).toLowerCase()).charAt(0).toUpperCase() + e.slice(1) : ""
};
$ablaze.filter.caps = $ablaze.filter.capitalize;
$ablaze.filter.title = function(e) {
    return e ? e.toLowerCase().split(" ").map((function(e) {
        return e.charAt(0).toUpperCase() + e.slice(1)
    })).join(" ") : ""
};
$ablaze.filter.lower = function(e) {
    return e ? e.toLowerCase() : ""
};
$ablaze.filter.upper = function(e) {
    return e ? e.toUpperCase() : ""
};
var __ablaze_filter_cut__ = function(e, t) {
    return e ? e.substring(0, t) : ""
};
$ablaze.filter.cut = function(e, t, a = !0) {
    var i = "";
    e.length > t && !0 === a && (i = "...");
    return `${__ablaze_filter_cut__(e,t)}${i}`
};
$ablaze.lorem = function(e, t) {
    ...
    switch (e[0]) {
        case "w":
            for (var o = 0; o < t; o++) {
                var l = a[n = Math.floor(s * Math.random())].trim().split(" ");
                i.push(l[Math.floor(s * Math.random())])
            }
            break;
        case "s":
            for (o = 0; o < t; o++) {
                var n = Math.floor(s * Math.random());
                i.push(a[n])
            }
    }
    return i.join(" ")
...
$ablaze.has = {};
$ablaze.has.value = function(e) {
    return !(!e || "" == e || " " == e || void 0 === e)
};
$ablaze.has.value.not_zero = function(e) {
    return !(!e || 0 == e || "" == e || " " == e || void 0 === e)
};
$ablaze.number.commas = function(e) {
    return e.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")
};
$ablaze.number.float = function(e, t = 2) {
    var a, i;
    return e = String(e).replace(/[^0-9\.\,]+/g, "").replace(/\,{1,}/g, ",").replace(/\.{1,}/g, ".").replace(/,/g, ""), amount = parseFloat(e).toFixed(t), e = amount.replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,"), cc = e.split("."), coins = cc[0], cents = String(cc[1]).replace(/,/g, "").replace(/[0]{1,}$/g, ""), a = 0 === parseInt(cents) ? `${coins}` : `${coins}.${cents}`, i = 0 === parseInt(cents) ? `${parseInt(coins.replace(/,/g,""))}` : `${parseInt(coins.replace(/,/g,""))}.${cents}`, out = {
        display: "" === a.split(".")[1] ? `${a.split(".")[0]}.${Array(t+1).join("0")}` : a,
        value: parseFloat(i)
    }, out, "" !== out.display.split(".")[1] && "undefined" !== out.display.split(".")[1] || (out.display = out.display.split(".")[0]), out
};
$ablaze.number.currency = function(e) {
    return $ablaze.number.float(e, 2)
};
$ablaze.string = {};
...
$ablaze.random = function(e, t) {
    for (var a = "", i = t, s = 0; s < e; s++) a += i.charAt(Math.floor(Math.random() * i.length));
    return a
};
$ablaze.random.letters = function(e) {
    return $ablaze.random(e, $ablaze.string.lowercase + $ablaze.string.uppercase)
};
$ablaze.random.alphanum = function(e) {
    return $ablaze.random(e, $ablaze.string.lowercase + $ablaze.string.uppercase + $ablaze.string.digits)
};
$ablaze.random.lowercase = function(e) {
    return $ablaze.random(e, $ablaze.string.lowercase)
};
$ablaze.random.uppercase = function(e) {
    return $ablaze.random(e, $ablaze.string.uppercase)
};
$ablaze.random.digits = function(e) {
    return $ablaze.random(e, $ablaze.string.digits)
};
$ablaze.random.hexdigits = function(e) {
    return $ablaze.random(e, $ablaze.string.hexdigits)
};
$ablaze.random.all = function(e) {
    return $ablaze.random(e, $ablaze.string.lowercase + $ablaze.string.uppercase + $ablaze.string.digits + $ablaze.string.hexdigits + $ablaze.string.others)
};
...
$ablaze.field.int = function(e) {
    return e = (e = (e = e.split(".")[0]).replace(/((?!(^[-?]|[0-9])).)/g, "")).replace(/^[0]/, ""), (e = parseInt(e).toString()).replace(/^-0/, "-")
};
$ablaze.field.int.positive = function(e) {
    return (e = (e = String(e)).replace(/^0/, "")).replace(/((?!([0-9])).)/g, "")
};
$ablaze.field.int.negative = function(e) {
    return (e = String(e)).length > 0 && (e = (e = (e = e.replace(/^/, "-")).replace(/-{1,}/, "-")).replace(/^-0{1,}/, "-")), 1 == e.length && (e = e.replace(/-/, "")), e.replace(/((?!(^[-?]|[0-9])).)/g, "")
};
$ablaze.field.number = function(e, t) {
    l = String(String(e).split(".")[1]).length;
    l && !t && (t = l);
    return $ablaze.number.float(e, t)
};
$ablaze.field.float = function(e, t = 4) {
    return $ablaze.number.float(e, t).value
};
$ablaze.field.currency = function(e) {
    return $ablaze.field.number(e, 2)
};
$ablaze.field.money = function(e) {
    return $ablaze.field.number(e, 2)
};
$ablaze.field.list = function(e, t = 10) {
    return e.reverse().slice(0, t).reverse()
};
const AblazeMakeRecords = (e, t) => t.reduce((t, a) => (t[a[e]] = a, t), {});
AblazeMakeRecords.dynamicSort = e => {
    let t = 1;
    return "-" === e[0] && (t = -1, e = e.substr(1)),
        function(a, i) {
            return (a[e] < i[e] ? -1 : a[e] > i[e] ? 1 : 0) * t
        }
}, AblazeMakeRecords.dynamicSortMultiple = (...e) => function(t, a) {
    for (var i = 0, s = 0, o = e.length; 0 === s && i < o;) s = AblazeMakeRecords.dynamicSort(e[i])(t, a), i++;
    return s
}, AblazeMakeRecords.search_by = (e, t, a, i) => i ? e.filter(e => String(e[t]).startsWith(String(a))) : e.filter(e => String(e[t]).toLowerCase().includes(String(a).toLowerCase())), AblazeMakeRecords.search_by_not = (e, t, a, i) => i ? e.filter(e => !String(e[t]).startsWith(String(a))) : e.filter(e => !String(e[t]).toLowerCase().includes(String(a).toLowerCase())), AblazeMakeRecords.group_by = function(e, t) {
    return e.reduce((e, a) => ((e[a[t]] = e[a[t]] || []).push(a), e), {})
};
AblazeMakeRecords.updates_only = function(e, t) {
    let a, i, s, o, l;
    if (JSON.stringify(e) === JSON.stringify(t)) return !1;
    for (a = [], i = o = 0, l = t.length; o < l; i = ++o) s = t[i], JSON.stringify(s) !== JSON.stringify(e[i]) && a.push(s);
    return a
};
AblazeMakeRecords.updated_values = function(e, t) {
    const a = {};
...
class AblazeBaseRecords {
    ...
    tail(e = 10) {
        return this.list.reverse().slice(0, e).reverse()
    }
    by(e = "id") {
        return AblazeMakeRecords(e, this.list)
    }
    sort(...e) {
        return this.list.sort(AblazeMakeRecords.dynamicSortMultiple(...e))
    }
    group_by(e = "account_id") {
        return AblazeMakeRecords.group_by(this.list, e)
    }
    find(e, t) {
        return this.list.filter(a => a[e] === t)
    }
    find_not(e, t) {
        return this.list.filter(a => a[e] !== t)
    }
    search(e, t, a = !1) {
        let i = [];
        return e && "object" == typeof e && e.constructor === Array ? e.forEach(e => {
            i = i.concat(AblazeMakeRecords.search_by(this.list, e, t, a))
        }) : i = AblazeMakeRecords.search_by(this.list, e, t, a), i
    }
    search_not(e, t, a = !1) {
        let i = [];
        return e && "object" == typeof e && e.constructor === Array ? e.forEach(e => {
            i = i.concat(AblazeMakeRecords.search_by_not(this.list, e, t, a))
        }) : i = AblazeMakeRecords.search_by_not(this.list, e, t, a), i
    }
    dirty(e) {
        const t = this.list;
        return AblazeMakeRecords.updates_only(t, e)
    }
    dirty_form(e, t) {
    ...
    VuexKeyValue = {
        install(e, t) {
            ...
            class i {
                ...
                get value() {
                    return t.store.getters[`abz-${this.model}/value`]
                }
                set value(e) {
                    t.store.dispatch(`abz-${this.model}/value`, e)
                }
                get items() {
                    return t.store.getters[`abz-${this.model}/value`]
                }
                ...
                keys() {
                    return Object.keys(t.store.getters[`abz-${this.model}/value`])
                }
                values() {
                    return Object.values(t.store.getters[`abz-${this.model}/value`])
                }
            }
            e.prototype.$abz = {};
            e.store_abz = function(s, o = {}) {
                t.store.registerModule(`abz-${s}`, a);
                e.prototype.$abz[s] = new i(s);
                t.store.dispatch(`abz-${s}/value`, o);
                return e.prototype.$abz[s]
            }
        }
    },
    VueDevice = {
        install(e, t = {}) {
            const a = function(e) {
                    var t, a = window.innerWidth;
                    a <= 600 ? t = "xs" : 600 < a && a < 960 ? t = "sm" : 960 < a && a < 1264 ? t = "md" : 1264 < a && a < 1904 ? t = "lg" : a > 1904 && (t = "xl");
                    return t
                },
                i = function(e) {
                    return "xs" === e ? 1 : "sm" === e ? 2 : "md" === e ? 3 : "lg" === e ? 4 : "xl" === e ? 5 : void 0
                };
            e.prototype.$device = {};
            e.prototype.$device.size = function() {
                return a()
            };
            e.prototype.$device.is = function(e) {
                return t = i(e), s = i(a()), parseInt(t) === parseInt(s);
                var t, s
            };
            e.prototype.$device.lte = function(e) {
                return t = i(e), s = i(a()), parseInt(t) >= parseInt(s);
                var t, s
            };
            e.prototype.$device.gte = function(e) {
                return t = i(e), s = i(a()), parseInt(t) <= parseInt(s);
                var t, s
            };
            e.prototype.$device.lt = function(e) {
                return t = i(e), s = i(a()), parseInt(t) > parseInt(s);
                var t, s
            };
            e.prototype.$device.gt = function(e) {
                return t = i(e), s = i(a()), parseInt(t) < parseInt(s);
                var t, s
            };
            e.mixin({
                beforeCreate() {
                    const t = this.$options.sync;
                    if (t) {
                        this.$options.computed || (this.$options.computed = {});
                        const a = Object.keys(this.$attrs);
                        t.forEach(t => {
                            a.includes(t) || e.util.warn(`Missing required sync-prop: "${t}"`, this);
                            this.$options.computed[t] = {
                                get() {
                                    return this.$attrs[t]
                                },
                                set(e) {
...
const aceEditor = {
        ...
        mounted() {
            ...
            t.style.fontSize = this.font;
            t.style.zIndex = 0;
            window.addEventListener("keyup", function(t) {
                var a = e.editor.getValue();
                e.code = a;
                a.startsWith("#") ? e.$emit("update:code", "\n" + a) : e.$emit("update:code", a)
            }.bind(this));
        ...
        methods: {
            random_id_name() {
                return `${this.lang}-${function(e=32,t="0123456789abcdefghijklmnopqrstuvwxyz"){for(var a="",i=t,s=0;s<e;s++)a+=i.charAt(Math.floor(Math.random()*i.length));return a}()}`
            },
            ...
            theHeaders() {
                ...
                if (this.show) {
                    this.show.forEach(t => {
                        e.push({
                            value: t,
                            text: "id" === t ? $ablaze.filter.upper(t) : $ablaze.filter.title(t),
                            class: this.headerClass
                        })
                    });
                    e.push({
    ...
    abzFullstackLog = {
        ...
        methods: {
            log() {
                var e = this;
                axios.get(this.api.live_log).then(t => {
                    var a = t.data;
                    e.live_log = a
                });
    ...
    abzFullstackBar = {
        ...
        computed: {},
        methods: {
            setSelectedLang: function(e) {
                this.selected.lang = e
            }
        }
    },
    abzFullstackRun = {
    ...
    abzFullstackOutput = {
        ...
        methods: {
            htmlDialog(e) {
                this.custom_html_dialog = !0;
                this.custom_html_part = e
            }
        },
        computed: {
            preExampleClass: () => "pa-2 pink--text darken-2 text-left overflow-y-auto",
            active_live() {
    ...
    abzFullstackLinks = {
        ...
        methods: {
            ...
            autoUpdate: function() {
                return this.form.id && "edit" === this.action ? this.actionSave() : null
            },
            createDelete: function() {
                return "edit" === this.action ? this.actionDelete() : this.actionCreate()
            },
            actionCreate: function() {
                if ("" !== this.form.link) {
                    var e = this,
                        t = $ablaze.random.alphanum(16),
                        a = AblazeRecords(this.items).by("id"),
                        i = !1;
                    ...
                    for (; !i;)
                        if (a[t]) t = $ablaze.random.alphanum(16);
                        else {
                            s(t);
                            i = !0
                        }
            ...
            actionEdit: function(e) {
                var t = AblazeRecords(this.items).by("id")[e];
                this.form.id = e;
                this.form.title = t.title;
                this.form.link = t.link
            },
            actionSave: function() {
                var e = AblazeRecords(this.items).by("id");
                if (this.form.id) {
                    var t = e[this.form.id];
                    t.title = this.form.title;
                    t.link = this.form.link;
                    this.items = Object.values(e)
                }
            },
            actionDelete: function() {
                var e = AblazeRecords(this.items).by("id");
                delete e[this.form.id];
                this.items = Object.values(e);
                this.form.id = null;
    ...
    abzFullstack = {
        ...
        computed: {
            copyActiveEditor() {
                return this.isActive("py-live") ? this.form.snippets.python : this.isActive("py-sanic") ? this.form.snippets.py.sanic : this.isActive("py-cherrypy") ? this.form.snippets.py.cherrypy : this.isActive("py-quartpy") ? this.form.snippets.py.quartpy : this.isActive("js-live") ? this.form.snippets.javascript : this.isActive("js-vue") ? this.form.snippets.js.vue : this.isActive("sh-live") ? this.form.snippets.sh.live : this.isActive("sh-script") ? this.form.snippets.sh.script : this.isActive("html-live") ? this.form.snippets.html.live : this.isActive("html-server") ? this.form.snippets.html.server : this.isActive("html-head") ? this.form.snippets.html.head : this.isActive("html-script") ? this.form.snippets.html.script : void 0
            }
        },
        methods: {
            runCode: function() {
                let url_run = e => `${this.api.py_run}/${e}`,
                    url_html = `${this.api.html_run}`;
                this.console_log = [];
                var self = this;
                if (this.isActive("js-live")) {
                    ...
                    axios.post(url_html, {
                        ...
                        self.html_live_dialog = !0
                    })
                } else if (this.isActive("py-live")) {
                    var action = "live",
                        code = this.form.snippets.python;
                    axios.post(url_run(action), {
                        data: code
                    }).then(e => {
                        self.console_log = e.data
                    })
                } else if (this.isActive("py-sanic")) {
                    var action = "sanic",
                        code = this.form.snippets.py.sanic;
                    axios.post(url_run(action), {
                        data: code
                    }).then(e => {})
                } else if (this.isActive("py-cherrypy")) {
                    var action = "cherrypy",
                        code = this.form.snippets.py.cherrypy;
                    axios.post(url_run(action), {
                        data: code
                    }).then(e => {})
                } else if (this.isActive("py-quartpy")) {
                    var action = "quart",
                        code = this.form.snippets.py.quartpy;
                    axios.post(url_run(action), {
                        data: code
                    }).then(e => {})
                } else if (this.isActive("sh-live")) {
                    var action = "shell",
                        code = this.form.snippets.sh.live;
                    axios.post(url_run(action), {
                        data: code
                    }).then(e => {
                        self.console_log = e.data
                    ...
                    var action = "sh",
                        code = this.form.snippets.sh.script;
                    axios.post(url_run(action), {
                        data: code
                    }).then(e => {
                        self.console_log = e.data
            ...
            stopCode: function() {
                let e = e => `${this.api.py_stop}/${e}`;
                this.isActive("py-live") ? axios.get(e("live")).then(e => {}) : this.isActive("py-sanic") || this.isActive("py-cherrypy") || this.isActive("py-quartpy") ? axios.get(e("server")).then(e => {}) : (this.isActive("sh-live") || this.isActive("sh-script")) && axios.get(e("shell")).then(e => {})
            }
        }
    },
    abzSnippetBar = {
        ...
        created() {
            isLinux && this.allowed_langs.push("python");
    ...
    abzSnippet = {
        ...
        methods: {
            ...
            runCode: function() {
                ...
                this.console_log = [];
                var self = this;
                if (this.isActive("javascript")) try {
                    eval(`console.log=console.print; ${code}`);
                    eval("console.log=console._log;")
                } catch (e) {
                    var err = `Error at line[${e.lineNumber}]: ${e.message}`;
    ...
    fullstackTable = {
        ...
        computed: {
            theItems() {
                ...
                this.items.forEach((a, i) => {
                    (e = JSON.parse(JSON.stringify(a))).info && (e.info = $ablaze.filter.cut(e.info, 2));
                    t.push(e)
                });
                return t
            }
        ...
        methods: {
            createItem: function() {
                var e = this.api.crud.fullstack + "/create";
                axios.post(e, {
                    id: null,
                    name: "Untitled",
                    tags: null,
            ...
            editItem: function(e) {
                var t = $ablaze.records(this.items).by("id");
                this.active = t[e];
                this.page_active = "fullstack-editor"
            },
            deleteItem: function(e) {
                var t = this.api.crud.fullstack + "/delete";
                axios.post(t, {
                    id: e
                }).then(e => {
                    this.items = e.data.data
            ...
            getItems: function() {
                var e = this.api.crud.fullstack + "/all";
                axios.post(e, {}).then(e => {
                    this.items = e.data.data
                })
            }
    ...
    snippetsTable = {
        ...
        computed: {
            theItems() {
                var e, t = [];
                this.items.forEach((a, i) => {
                    (e = JSON.parse(JSON.stringify(a))).info && (e.info = $ablaze.filter.cut(e.info, 85));
                    t.push(e)
                });
                return t
            }
        ...
        methods: {
            createItem: function() {
                var e = this.api.crud.snippet + "/create";
                axios.post(e, {
                    id: null,
                    lang: "python",
                    name: "Untitled",
            ...
            deleteItem: function(e) {
                var t = this.api.crud.snippet + "/delete";
                axios.post(t, {
                    id: e
                }).then(e => {
                    this.items = e.data.data
            ...
            getItems: function() {
                var e = this.api.crud.snippet + "/all";
                axios.post(e, {}).then(e => {
                    this.items = e.data.data
                })
            }
    ...
    appEditor = {
        ...
        created() {
            this.snippet.lang || (this.snippet.lang = "python")
        },
        mounted() {
            this.$el
        },
...
<v-app><abz-snackbar></abz-snackbar><abz-side-top :active.sync=page_active></abz-side-top><v-content class=\"fill-height text-center\" fluid style=\"overflow: hidden;\"><fullstack-table :active.sync=fullstack :key=Date.now() :page_active.sync=page_active :show=\"['id', 'name', 'tags', 'info']\" v-if=\"(page_active==='fullstack')\"></fullstack-table><snippets-table :active.sync=snippet :key=Date.now() :page_active.sync=page_active :show=\"['id', 'name', 'lang', 'tags', 'info']\" v-if=\"(page_active==='snippets')\"></snippets-table>
<v-container v-if=\"(page_active==='settings')\">
<h3 class=mt-4> Looking for the Database File? </h3><h5 class=\"red--text accent-3 mt-3\"> Here is the path to the database. </h5><h5 @click=copyText(db_path) class=\"blue--text accent-4 mt-3\" style=\"cursor: pointer; text-decoration: underline;\"> {{ db_path }} </h5></v-container></v-content><abz-side-bottom></abz-side-bottom></v-app>
        `,
        ...
        created() {
            var e = this;
            axios.get(this.api.crud.db.path).then(t => {
                var a = t.data;
                e.db_path = String(a)
            })
        },
        ...
        methods: {
            download: function() {
                ...
                e.download = "database.db";
                e.href = this.api.crud.db.export;
                e.click();
            ...
            upload: function() {
                var e = this;
                let t = new FormData;
                t.append("file", this.files);
                this.files && axios.post(this.api.crud.db.import, t, {
                    headers: {
            ...
            upload_multiple: function() {
                ...
                axios.post(this.api.crud.db.import, e, {
                    headers: {
                        "Content-Type": "multipart/form-data"
                    }
    ...
    theApp = {
        ...
        methods: {
            updateFullstack: $ablaze.throttle((function() {
                var e = this.api.crud.fullstack + "/update",
                    t = JSON.parse(JSON.stringify(this.fullstack));
                axios.post(e, t).then(e => {
                    e.data
                })
            }), 3e3),
            updateSnippet: $ablaze.throttle((function() {
                var e = this.api.crud.snippet + "/update",
                    t = JSON.parse(JSON.stringify(this.snippet));
                axios.post(e, t).then(e => {
                    e.data
                })
            }), 3e3)
...
let BASE_URL = `${window.location.protocol}//${window.location.hostname}:8012`,
    THE_URL = `${window.location.protocol}//${window.location.hostname}`;
...
console.print = function(e) {
    var t = store.getters["abz-console_log/value"];
    t.push(e);
    store.dispatch("abz-console_log/value", t)
};
Vue.mixin({
    data: () => ({
        api: {
            crud: {
                ...
                db: {
                    ...
                    export: `${BASE_URL}/database/database`,
    ...
    computed: {
        ...
        snackbar: {
            ...
            set: function(e) {
                var t = this.$abz["snackbar-copy"].value;
                Object.keys(e).forEach(a => {
                    t[a] = e[a]
                });
                this.$abz["snackbar-copy"].value = t
            }
        },
        activeEditor: function() {
            var e = this.selected.lang,
                t = this.selected.py,
                a = this.selected.js,
                i = this.selected.sh,
                s = this.selected.html;
            return "python" === e ? `py-${t}` : "javascript" === e ? `js-${a}` : "html" === e ? `html-${s}` : "sh" === e ? `sh-${i}` : void 0
        }
    },
    methods: {
        live_py_url: function(e) {
            return `${THE_URL}:${e}`
        },
        copyText: function(e) {
            var t = document.getElementById("ABLAZE_COPY_TEXT_ID");
            t.innerHTML = e;
            t.select();
        ...
        copyTextId: function(e) {
            var t = document.getElementById(e);
            this.copyText(t.innerHTML)
        },
        isActive: function(e) {
